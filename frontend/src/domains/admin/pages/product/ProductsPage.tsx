...
import { ProductsStats } from '@/domains/admin/components/products/ProductsStats'
import { ProductsFilters } from '@/domains/admin/components/products/ProductsFilters'
import { ProductsTable } from '@/domains/admin/components/products/ProductsTable'
