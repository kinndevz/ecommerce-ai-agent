...
import { RolesTable } from '@/domains/admin/components/roles/RolesTable'
import { PermissionsTable } from '@/domains/admin/components/roles/PermissionsTable'
import { RoleFilters } from '@/domains/admin/components/roles/RoleFilters'
import { PermissionFilters } from '@/domains/admin/components/roles/PermissionFilters'
