...
/**
 * Ecommerce MCP Server - Entry Point
 *
 * Clean, modular MCP server for e-commerce operations
 */
...
// 👇 QUAN TRỌNG: Phải export class DO ra ngoài.
// Dùng "as MyMCP" để khớp với cấu hình trong wrangler.toml của bạn
